...
def get_args():
    ...
    # SPG
    parser.add_argument('--spg-thr', nargs='*', type=float, help='SPG threshold set')
    parser.add_argument('--spg-thr-1h', type=float, default=0.7, help='SPG threshold')
    parser.add_argument('--spg-thr-1l', type=float, default=0.01, help='SPG threshold')
    parser.add_argument('--spg-thr-2h', type=float, default=0.5, help='SPG threshold')
    parser.add_argument('--spg-thr-2l', type=float, default=0.05, help='SPG threshold')
    parser.add_argument('--spg-thr-3h', type=float, default=0.7, help='SPG threshold')
    parser.add_argument('--spg-thr-3l', type=float, default=0.1, help='SPG threshold')
    ...
    args.spg_thr = ((args.spg_thr_1h, args.spg_thr_1l),
                    (args.spg_thr_2h, args.spg_thr_2l),
                    (args.spg_thr_3h, args.spg_thr_3l))
